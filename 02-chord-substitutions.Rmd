...
This chapter attempts to organize information that has to do with replacing chords with others. There seem to be many ways of thinking about this, and what follows describes just some of them.

## Concepts and Terms {-}
- **Soloing and Comping**
  - The concepts described here are used both for soloing and comping applications.
...
- **Example 1: Superpositions over Cmaj7 in C Major**
...
- **Example 2: Superpositions over Fmaj7 in C Major**
...
## Functioning Dominant Substitutions b3 Away {-}
