...
This chapter attempts to organize information that has to do with playing a different chord than what is written on a chart or lead sheet. There seem to be many ways of thinking about this.
...
## Functioning Dominant Subsitions b3 Away
A functioning dominant can be substituted by any other dominant that is located a multiple of a minor 3rd away. Barry Harris refers to this as "playing with your sisters and brothers". Such substitutions yield interesting note choices, and are a different approach to alterations than using the Melodic Minor Scale.

One of the substituting dominant chords (b5 away) is the tritone sub.

**Example 1: G7**: Building a dom7 chord on the b5 of G7 (2 multiples of b3 away) creates Db7, which contains the notes Db, F, Ab, B. These are b5, b7, b9, and 3 in reference to G7 - so substituting Db7 creates an altered G7 with b5 and b9.
...
display_sub_table(odf = d7_b3_sub_df, caption = "Functioning Dominant Subsitions b3 Away",
...
Some ideas to add movement to chords.

- **Secondary dominants and ii chords**
  - Major and minor chords (not m7b5) can be preceded by a **secondary dominant** - a dominant chord that resolves a 4th up (or 5th down). The secondary dominants (besides the main V) are not in the original scale, but can be played before their resolution chords to add interest. For example, the V chord in C Major is G7 (the dominant of Cmaj7); Dm7's secondary dominant is A7, Em7's is B7, and so on.
  - Taking this further, a functioning dominant can be preceeded by its **ii** chord. Generally, the ii chord is minor 7 when resolving to major or maj7, and m7b5 when resolving to a minor, m7 or m6.
