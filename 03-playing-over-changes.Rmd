...
- **iim7b5-V**
  - This situation is more complicated than with a major ii-V. In much of jazz music, the iim7b5 in a minor ii-V is frequently thought of as coming from the natural minor harmony, while the V is coming from harmonic minor (E.g. Am7b5 in Am7b5-D7 comes from G Natural Minor, or the related Bb major, and D7 comes from G Harmonic Minor). For this reason, the Locrian mode would be used over iim7b5, and Phrygian Dominant over the V. Playing the Phrygian Dom scale over iim7b5 would introduce a natural 6, which is not present in Locrian. In gypsy jazz, the parent harmonic minor scale is used over both chords (and even over the i - even if the tonic chord is voiced as m6 with a natural 6). This is the Locrian #6 mode when played over ii, and Phrygian Dominant when played over V. Example: G harmonic minor over Am7b5-D7.
  ...
  - Scales over iim7b5-V:
      ...
      - Parent Harmonic Minor scale over both chords for a gypsy jazz sound.
